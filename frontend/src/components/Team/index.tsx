      ...
      <div className={styles.team_actions}>
        <button className={styles.blue}>
          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
               ...
               viewBox="0 0 172 172"
               style={{fill: "#000000"}}>
            <g fill="none" fillRule="nonzero" stroke="none" strokeWidth="1" strokeLinecap="butt" strokeLinejoin="miter" stroke-miterlimit="10" strokeDasharray="" strokeDashoffset="0" fontFamily="none" fontWeight="none" fontSize="none" textAnchor="none" style={{mixBlendMode: "normal"}}>
        ...
        <button className={styles.green}>
          <img src="https://img.icons8.com/material/50/000000/plus-math--v2.png"/>
          <span>Invite</span>
        </button>
